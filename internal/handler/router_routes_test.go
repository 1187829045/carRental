...
func TestRouterHasMenuRoutesUnderBasePath(t *testing.T) {
	...
	require := []string{
		...
		"/carRental/druid/",
		"/carRental/druid/datasource.json",
		"/carRental/druid/sql.json",
		"/carRental/druid/weburi.json",
		"/carRental/druid/websession.json",
		"/carRental/druid/reset-all.json",
		"/carRental/druid/reset-sql.json",
		"/carRental/druid/reset-web.json",
		"/carRental/druid/reset-datasource.json",
